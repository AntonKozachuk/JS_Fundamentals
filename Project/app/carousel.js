    class Carousel {
        ...
        push() {
            ...
            div.innerHTML = `<h4 class="card-title"></h4><p class="card-text">Some example text some example text. John Doe is an architect and engineer</p>     <a href="#" class="btn btn-primary">See Profile</a>`;

            let div2 = document.createElement('div');
            div2.className = "img-top";
            let math = Math.round(Math.random()*75);
            div2.style.backgroundImage =
            `url('https://randomuser.me/api/portraits/men/${math}.jpg')`;
